...
{
	return /*CDuiString(CPaintManagerUI::GetInstancePath()) + */_T("skin\\QQRes");
}
...
LRESULT ChatDialog::OnDestroy(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	::PostQuitMessage(0L);//在收到WM_DESTROY消息之后发送WM_QUIT消息
	bHandled = FALSE;
	return 0;
}
